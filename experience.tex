...
\cventry[Inter-University Centre for Astronomy and Astrophysics (IUCAA), Pune, India]{satellite}{Software Engineer, \href{https://suit.iucaa.in}{SUIT} Payload of Aditya-L1 Mission}{Jun 2023}{Present}

\cvdescitem{Designed and implemented the SUIT data processing pipeline, handling $100$ Gb of daily data and delivering science-ready products. Developed the data processing methods required for the data reduction.}
\cvdescitem{Developing the data processing python toolkit for public users. It performs distortion correction, deconvolution, spike removal and contamination correction on level-1 data.}
...
\cvdescitem{Developed and automated the \href{https://suit.iucaa.in}{SUIT website} for outreach product uploads.}
...
\cventry[Inter-University Centre for Astronomy and Astrophysics (IUCAA), Pune, India]{satellite}{AstroSat Support Executive, \href{https://astrosat.iucaa.in/czti/home}{CZTI} Payload of AstroSat Mission}{Feb 2023}{May 2023}
\cvdescitem{Developed an automated Gamma Ray Burst (GRB) detection algorithm using the Sum Threshold method (Paper in preparation). This new module has a detection efficieny of 80\% on CZTI data, a significant improvement compared to other available modules.}
...
\cvdescitem{Maintained the CZTI GRB catalog and updated it on the website (\href{https://astrosat.iucaa.in/czti/grb}{link}).}
